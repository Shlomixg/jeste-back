                ...
                <div class="conversation">
                  <div class="conversation-container">
                    ...
                    <div v-for="(msg, idx) in msgs" :key="idx" class="message" :class="msgClass(msg)">
                      <span v-if="msg.from !== nickname" :style="{color: msg.msgColor}">{{msg.from, msgColor}}:</span>
                      {{msg.txt}}
                      <span class="metadata">
                  ...
                  <form class="conversation-compose">
                    ...
                    <input v-model="newMsg.txt" class="input-msg" name="input" placeholder="Type a message" autocomplete="off" autofocus>
                    <div class="photo">
